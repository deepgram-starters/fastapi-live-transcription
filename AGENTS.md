# fastapi-live-transcription

FastAPI demo app for Deepgram Live Transcription.
...
```
feat(fastapi-live-transcription): add diarization support
fix(fastapi-live-transcription): resolve WebSocket close handling
refactor(fastapi-live-transcription): simplify session endpoint
